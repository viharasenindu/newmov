...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://t.me/SinhalaFilms_LK"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://t.me/SinhalaCryptoNews'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/SinhalaFilms_LK')
            ],[
